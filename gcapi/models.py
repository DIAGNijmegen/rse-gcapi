...
#   timestamp: 2023-03-17T15:09:33+00:00
...
@dataclass
class BooleanClassificationAnnotation:
    id: str
    image: str
    grader: Optional[int]
...
@dataclass
class BooleanClassificationAnnotationRequest:
    image: str
    grader: Optional[int]
    created: Optional[str]
    name: str
...
@dataclass
class ComponentInterfaceValuePost:
    interface: str
...
@dataclass
class ComponentInterfaceValuePostRequest:
    interface: str
    value: Optional[Dict[str, Any]]
    file: Optional[bytes]
    image: Optional[str]
...
@dataclass
class ETDRSGridAnnotationRequest:
    grader: Optional[int]
    created: Optional[str]
    image: str
    fovea: List[float]
...
@dataclass
class HangingProtocolRequest:
    json_: Dict[str, Any]


@dataclass
class ImageLevelAnnotationsForImage:
    quality: str
    pathology: str
    retina_pathology: str
...
@dataclass
class ImageTextAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: str
    text: str
...
@dataclass
class OctRetinaImagePathologyAnnotation:
    id: str
    created: Optional[str]
    grader: Optional[int]
    image: str
...
@dataclass
class OctRetinaImagePathologyAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: str
    macular: Optional[bool]
...
@dataclass
class PaginatedAlgorithmImageList:
    count: Optional[int]
    next: Optional[str]
...
@dataclass
class PatchedArchiveItemPostRequest:
    archive: Optional[str]
    values: Optional[List[ComponentInterfaceValuePostRequest]]


@dataclass
class PatchedBooleanClassificationAnnotationRequest:
    image: Optional[str]
    grader: Optional[int]
    created: Optional[str]
    name: Optional[str]
...
@dataclass
class PatchedDisplaySetPostRequest:
    reader_study: Optional[str]
    values: Optional[List[ComponentInterfaceValuePostRequest]]
    order: Optional[int]
...
@dataclass
class PatchedFollowRequest:
    flag: Optional[str]


@dataclass
class PatchedImageTextAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: Optional[str]
    text: Optional[str]
...
@dataclass
class PatchedOctRetinaImagePathologyAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: Optional[str]
    macular: Optional[bool]
...
@dataclass
class PatchedRetinaImagePathologyAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: Optional[str]
...
@dataclass
class PatchedSinglePolygonAnnotationRequest:
...
@dataclass
class PatchedUserUploadCompleteRequest:
    parts: Optional[List[PartRequest]]


@dataclass
class PatchedUserUploadPresignedURLsRequest:
...
@dataclass
class RawImageUploadSessionRequest:
    creator: Optional[int]
    error_message: Optional[str]
    user_uploads: Optional[List[str]]
    archive: Optional[str]
...
@dataclass
class RetinaImagePathologyAnnotation:
    id: str
    created: Optional[str]
    grader: Optional[int]
    image: str
...
@dataclass
class RetinaImagePathologyAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: str
    oda_present: bool
...
@dataclass
class SingleLandmarkAnnotationSerializerNoParentRequest:
    image: str
    landmarks: List[List[float]]


@dataclass
class SinglePolygonAnnotation:
    id: str
...
@dataclass
class SinglePolygonAnnotationRequest:
    value: List[List[float]]
    annotation_set: str
    z: Optional[float]
    interpolated: Optional[bool]
...
@dataclass
class SinglePolygonAnnotationSerializerNoParentRequest:
    id: Optional[str]
    value: List[List[float]]
    z: Optional[float]
    interpolated: Optional[bool]
...
@dataclass
class UserUploadCreateRequest:
    filename: str


@dataclass
class UserUploadParts:
    pk: str
    created: str
    filename: str
    key: str
...
@dataclass
class HyperlinkedComponentInterfaceValue:
    interface: ComponentInterface
    value: Optional[Dict[str, Any]]
    file: Optional[str]
    image: str
...
@dataclass
class ImagePathologyAnnotation:
    id: str
    created: Optional[str]
    grader: Optional[int]
    image: str
...
@dataclass
class ImagePathologyAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: str
    pathology: PathologyEnum
...
@dataclass
class ImageQualityAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: str
    quality: QualityEnum
...
@dataclass
class LandmarkAnnotationSetRequest:
    grader: Optional[int]
    created: Optional[str]
    singlelandmarkannotation_set: List[
...
@dataclass
class NestedPolygonAnnotationSet:
    id: str
    image: str
    grader: Optional[int]
    created: Optional[str]
...
@dataclass
class NestedPolygonAnnotationSetRequest:
    image: str
    grader: Optional[int]
    created: Optional[str]
    name: str
...
@dataclass
class PaginatedComponentInterfaceList:
    count: Optional[int]
    next: Optional[str]
    previous: Optional[str]
...
@dataclass
class PaginatedHyperlinkedJobList:
    count: Optional[int]
    next: Optional[str]
    previous: Optional[str]
...
@dataclass
class PaginatedRawImageUploadSessionList:
    count: Optional[int]
    next: Optional[str]
    previous: Optional[str]
...
@dataclass
class PaginatedWorkstationConfigList:
    count: Optional[int]
    next: Optional[str]
    previous: Optional[str]
...
@dataclass
class PaginatedWorkstationList:
    count: Optional[int]
    next: Optional[str]
    previous: Optional[str]
...
@dataclass
class PatchedImagePathologyAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: Optional[str]
...
@dataclass
class PatchedImageQualityAnnotationRequest:
    created: Optional[str]
    grader: Optional[int]
    image: Optional[str]
...
@dataclass
class PatchedLandmarkAnnotationSetRequest:
    grader: Optional[int]
    created: Optional[str]
...
@dataclass
class PatchedNestedPolygonAnnotationSetRequest:
    image: Optional[str]
    grader: Optional[int]
    created: Optional[str]
    name: Optional[str]
...
@dataclass
class PaginatedArchiveItemList:
    count: Optional[int]
    next: Optional[str]
    previous: Optional[str]
...
@dataclass
class PaginatedHyperlinkedImageList:
    count: Optional[int]
    next: Optional[str]
    previous: Optional[str]
...
@dataclass
class PaginatedReaderStudyList:
    count: Optional[int]
    next: Optional[str]
    previous: Optional[str]
...
@dataclass
class PaginatedRetinaImageList:
    count: Optional[int]
    next: Optional[str]
    previous: Optional[str]
