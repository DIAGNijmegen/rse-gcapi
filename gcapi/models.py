...
#   timestamp: 2026-07-14T16:03:01+00:00
...
class WorkstationConfig:
    ...
    default_annotation_color: str | None | None
...
class DisplaySetPost:
    ...
    view_content: Any
    description: str
    descriptions_map_safe: dict[str, str]
    index: int | None
    title: str = ""


@dataclass
class ExternalEvaluationUpdate:
    metrics: Any | None
    status: StatusEnum
    error_message: str | None
...
@dataclass
class PaginatedHyperlinkedInvocationList:
    count: int
    next: str | None
    previous: str | None
    results: list[HyperlinkedInvocation]
...
@dataclass
class PaginatedPublicChallengeList:
    count: int
    next: str | None
    previous: str | None
...
@dataclass
class PatchedExternalEvaluationUpdateRequest:
    metrics: Any | None
...
@dataclass
class PatchedExternalEvaluationRequest:
    method: str | None
...
@dataclass
class ReaderStudyAlgorithm:
    interfaces: list[AlgorithmInterface]


@dataclass
class ReaderStudyAlgorithmImplementation:
    algorithm: str
    reader_study_algorithm: ReaderStudyAlgorithm
...
class Question:
    ...
    algorithms: list[ReaderStudyAlgorithmImplementation]
